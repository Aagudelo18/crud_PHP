...
if (isset($_SESSION["usuario"])){
    ...
    function Header()
    {
        ...
        $this->SetX(50);
        $this->Cell(25,10,'idVenta',1,0,'C',0);
        $this->Cell(25,10,'cantidad',1,0,'C',0,);
        $this->Cell(40,10,'FechaEntrega',1,0,'C',0);
    ...
    $id = $_GET["id"];
    $consulta = "SELECT venta.idVenta, venta.cantidad, venta.FechaEntrega, venta.Precio FROM venta WHERE venta.idVenta = $id";
    ...
    while ($row=$resultado->fetch_assoc()) {
        ...
        $pdf->Cell(25,10,$row['idVenta'],1,0,'C',0);
        $pdf->Cell(25,10,$row['cantidad'],1,0,'C',0);
        $pdf->Cell(40,10,$row['FechaEntrega'],1,0,'C',0);
