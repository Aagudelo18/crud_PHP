...
if (isset($_SESSION["usuario"])){
    ...
    <form action="update.php" method="post">
        <h2 class="text-white">Editar Venta</h2>
        <div class="mb-3 row">
    ...
    <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Cantidad</label>
            <div class="col-sm-10">
                <input type="number" name="cantidad" class="form-control" id="inputPassword" value="<?= $cat[4] ?>">
            </div>
    </div>
    <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Fecha Entrega</label>
            <div class="col-sm-10">
                <input type="date" name="FechaEntrega" class="form-control" id="inputPassword" value="<?= $cat[5] ?>">
            </div>
    </div>
    <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Precio</label>
            <div class="col-sm-10">
                <input type="number" name="Precio" class="form-control" id="inputPassword" value="<?= $cat[6] ?>">
            </div>
    </div>
