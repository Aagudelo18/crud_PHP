...
<?php
    ...
    function Header()
    {
        ...
        // Título
        $this->Cell(70,10,'Tabla Tipo Documento',0,0,'C');
        // Salto de línea
    ...
    $id = $_GET["id"];
    $consulta = "SELECT * FROM tipoDocumento WHERE tipoDocumento.idTipodocumento = $id";
    ...
    while ($row=$resultado->fetch_assoc()) {
        ...
        $pdf->Cell(10,10,$row['idTipodocumento'],1,0,'C',0);
