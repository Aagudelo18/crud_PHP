...
$id = $_GET["id"];
$consulta = "SELECT p.idProducto, p.Nombre, p.Descripcion, p.Precio, c.Nombre AS category  FROM producto AS p INNER JOIN categoria AS c
ON p.idCategoria=c.idCategoria WHERE p.idProducto = $id";
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->Cell(25,10,$row['idProducto'],1,0,'C',0);
    $pdf->Cell(25,10,$row['category'],1,0,'C',0);
