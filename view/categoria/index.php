...
if (isset($_SESSION["usuario"])){
    ...
    <div class="container py-3">
            <h2 class="text-center text-white">Categorias</h2>
            <div class="row justify-content-end mt-4">
                <div class="d-flex justify-content-between">
                    <a href="generarExcel.php" class="btn btn-success"><i class="bi bi-file-earmark-excel"></i></a>
                    <a href="/laparisinamvc/view/categoria/create.php" class="btn btn-primary"><i class="bi bi-plus-lg mr-1"></i>Crear Categoria</a>
                </div> 
            </div>
