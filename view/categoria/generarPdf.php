...
if (isset($_SESSION["usuario"])){
    ...
    function Header()
    {
        ...
        $this->SetX(50);
        $this->Cell(25,10,'idCategoria',1,0,'C',0);
    ...
    $id = $_GET["id"];
    $consulta = "SELECT categoria.idCategoria, categoria.Nombre, categoria.Descripcion FROM categoria WHERE categoria.idCategoria = $id";
    ...
    while ($row=$resultado->fetch_assoc()) {
        ...
        $pdf->Cell(25,10,$row['idCategoria'],1,0,'C',0);
